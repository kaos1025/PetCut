...
class PcText {
  static const display =
      TextStyle(fontSize: 28, fontWeight: FontWeight.w500, height: 1.15);
  static const h1 =
      TextStyle(fontSize: 22, fontWeight: FontWeight.w500, height: 1.25);
  ...
  static const label =
      TextStyle(fontSize: 11, fontWeight: FontWeight.w500, letterSpacing: 0.88);
}
